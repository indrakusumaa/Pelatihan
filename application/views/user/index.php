...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <a href="<?= base_url('user/tambah_u') ?> " class="btn btn-primary"> Tambah Proposal Kegiatan <i class="fas fa-plus"></i></a>


            <!-- <form style="float: right;" action="<?= base_url('user'); ?>" method="POST">
